    ...
    def __init__(self):
        ...
        try:
            self.connection = psycopg2.connect(
                dbname="dag0v25ipfvqli", user='dkyxylihtgnsgo', host='ec2-50-17-193-83.compute-1.amazonaws.com', 
                password="97e77d4fc534b3fbbe339b2f77bea1f32825a45f26fea1b6dbb1a7d17caadb59", port=5432
            )
